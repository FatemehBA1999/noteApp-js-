...
export default class NotesView {
  ...
  <div class="notes__preview">
    ...
    <textarea name="" class="notes__body" placeholder="Take Note"></textarea>
  </div>
    `;
  ...
  _createListItemHTML(id, title, body, updated) {
    ...
    <span class="notes__list-trash" data-note-id="${id}">
      <img src="/assets/images/Style=Filled.svg" alt="">
    </span>
    </div>
    ...
    notesContainer
      ...
      .forEach((noteItem) => {
        noteItem.addEventListener("click", (e) => {
          e.stopPropagation(); // تگ پدر فراخاونی نشود باعث میشود وقتی روی تگ فرزند کلیک میکنیم
